            ...
            <div className="glass rounded-2xl p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {href ? (
                        <a
                          href={href}
                          className="text-sm sm:text-base text-gray-900 dark:text-white hover:text-primary-400 transition-colors break-all"
                        >
                          {value}
                        </a>
                      ) : (
              ...
              <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-wrap gap-3">
                  {socialLinks.map(
                    ({ icon: Icon, name, url, color }, index) => (
                      <motion.a
                        key={name}
                        href={url}
                        target="_blank"
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-white/5 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary-500 focus:outline-none transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={5}
                  className="w-full px-4 py-3 rounded-lg bg-gray-100 dark:bg-white/5 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white focus:border-primary-500 focus:outline-none transition-colors resize-none"
