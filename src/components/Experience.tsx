            ...
            >
              ...
              <div className="mb-6">
                ...
                <ul className="space-y-2">
                  {profileData.reviewExperience.journals.map(
                    (journal, index) => (
                      <li
                        key={index}
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {profileData.certifications.map((cert, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-3 bg-gray-100 dark:bg-white/5 rounded-lg p-4"
                    >
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {profileData.references.map((ref, index) => (
                  <div
                    key={index}
                    className="bg-gray-50 dark:bg-white/5 rounded-lg p-6"
                  >
                    ...
                    {ref.url && (
                      <a
                        ...
                        className="block text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 mt-2"
                      >
                        View Profile →
                      </a>
                    )}
